...
RSpec.describe "/messages", type: :request do
  ...
  describe "get all messages /messages" do
  ...
  describe "get messages /messages/:id" do
    it "returns messages based on the param" do
      get "/messages/3"
      expect(response).to have_http_status(:success)
   ...
   it "returns a not found on the wrong param" do
  
        get "/messages/3"
        expect(response).to have_http_status(:not_found)
        expect(response.body).to inlcude(:not_found)
